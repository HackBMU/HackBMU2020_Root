...
plot.savefig('sensordata3.png')
os.replace("sensordata3.png", time.strftime("%Y%m%d.png"))
os.replace(time.strftime("%Y%m%d.png"), "sensor3/"+time.strftime("%Y%m%d.png"))
