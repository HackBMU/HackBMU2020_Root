...
plot.savefig('sensordata2.png')
os.replace("sensordata2.png", time.strftime("%Y%m%d.png"))
os.replace(time.strftime("%Y%m%d.png"), "sensor2/"+time.strftime("%Y%m%d.png"))
